const Infos = (props) => {
  return (
    <div className="w-infos-card-mobile h-infos-card-mobile bg-light-mode-white pt-8 px-6 rounded-lg shadow-lg">
      ...
      <div className="mb-6">
        <p className="text-light-mode-blue-two text-custom-h4">
      ...
      <div className="flex justify-between bg-light-mode-light-gray rounded-lg p-4 mb-6">
        ...
        <div className="flex flex-col items-center">
          ...
          <h3 className="font-semibold text-custom-h3">3938</h3>
        </div>
        <div className="flex flex-col items-center">
          <p className="text-light-mode-gray text-custom-h4">Following</p>
          <h3 className="font-semibold text-custom-h3">9</h3>
        </div>
      </div>
      ...
      <div className="flex flex-col text-custom-h4 text-light-mode-blue-two pb-12.5">
        ...
        <div className="flex gap-x-3 mb-3.5">
          ...
          <a href="https://github.blog" target="blank">https://github.blog</a>
        </div>
